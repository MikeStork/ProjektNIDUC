...
def crc_remainder(input_bitstring:str, polynomial_bitstring:str, initial_filler:str)->str:
...
def crc_check(input_bitstring:str, polynomial_bitstring:str, check_value:str)->bool:
